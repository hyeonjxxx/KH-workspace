...
<body>
	...
	<div class="container">
		...
		<div class="dropdown">
		  <button class="dropdown-toggle" type="button" data-toggle="dropdown" onclick="colorChange();">프로젝트 둘러보기
		  <span class="caret"></span></button>
		  <ul class="dropdown-menu">
			<div class="cateLeft">
			  <div><a href="#">모든 프로젝트</a></div>
			  <div><a href="#">인기 추천 프로젝트</a></div>
			  <div><a href="#">성공 임박 프로젝트</a></div>
			  <div><a href="#">신규 추천 프로젝트</a></div>
			...
			<script>
			  function colorChange(){
				...
				var tagColor = ["red","yellow","green"];
	  
				var num = Math.floor(Math.random() * tagColor.length);
				document.getElementsByClassName("tagBox").style.bacgroundColor = tagColor[num];
			  }
			</script>
