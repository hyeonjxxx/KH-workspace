...
public class MemberMenu {
	...
	// 전역으로 다 쓸수 있도록 Scanner 객체 생성
	private Scanner sc = new Scanner(System.in);
	
	// 전역으로  바로 MemberController 요청할수 있도록 객체 생성
	...
	/**
	 * 추가하고자하는  회원의 정보를 입력받아서 추가 요청할 수있는 화면
	 */
	...
	/**
	 * 조회 서비스 요청시 조회결과가 없을 때 보게 될 응답화면
	 * @param message 메세지
	 */
	...
	/**
	 * 조회 서비스 요청시 한 행 조회 된 결과 받아서 보게 될 응답화면
	 * @param m
	 */
	...
	/**
	 * 사용자에게 변경할 회원의 아이디, 변경할 정보들(비번, 이메일, 전화번호, 주소)을 입력받는 후 변경 요청하는 메소드
	 * @param keyword
	 */
