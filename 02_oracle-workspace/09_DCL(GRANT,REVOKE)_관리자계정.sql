...
-- 3_1. SMAPLE계정에 테이블을 생성할 수 있는 CREATET TABLE 권한부여
GRANT CREATE TABLE TO SAMPLE;
-- 3_2. SAMPLE계정에 테이블스페이스를 할당해주기 (SAMPLE 계정변경)
ALTER USER SAMPLE QUOTA 2M ON SYSTEM;

-- 4. SAMPLE계정에 뷰를 생설할 수 있는 CREATE VIEW 권한 부여
...
-- 5. SAMPL계정에 KH.EMPLOYEE테이블을 조회할 수 있는 권한 부여
